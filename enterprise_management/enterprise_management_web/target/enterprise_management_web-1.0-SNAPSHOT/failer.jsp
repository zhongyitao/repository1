            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="${pageContext.request.contextPath}/login.jsp" class="dropdown-toggle" data-toggle="dropdown">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p>未登录</p>
                    <a href="${pageContext.request.contextPath}/login.jsp"><i class="fa fa-circle text-gray"></i>离线</a>
                </div>
            </div>
            ...
            <section class="content">
                <div class="error-page">
                    ...
                    <div class="error-content">
                        <p>
                            登录失败 , 你可以返回到 <a href="${pageContext.request.contextPath}/login.jsp">登录</a>页面
                            重新登录
                        </p>
                    </div>
                    <!-- /.error-content -->
